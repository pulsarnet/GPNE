...
IMPL_FOR_TYPE_INNER(const vertex::Place*, const_place_ptr)
IMPL_FOR_TYPE_INNER(const vertex::Transition*, const_transition_ptr)
...
IMPL_FOR_TYPE_INNER(reachability::MarkingIndex, marking_index)