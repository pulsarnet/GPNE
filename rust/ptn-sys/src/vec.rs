...
rust_vec_shims!("const_place_ptr", *const ptn::net::place::Place);
rust_vec_shims!(
    "const_transition_ptr",
    *const ptn::net::transition::Transition
);
...
rust_vec_shims!(
    "const_marking_ptr",
    *const ptn::extension::reachability::Marking
);
